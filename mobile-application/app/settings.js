...
Drupal.settings.site_path = 'http://tddp.de'; // e.g. http://www.example.com
...
// App Title
drupalgap.settings.title = 'Where are you!';
 
// App Front Page
//drupalgap.settings.front = 'dashboard';
drupalgap.settings.front = 'appinfo';
//drupalgap.settings.front = 'my_module_map';

// Theme
drupalgap.settings.theme = 'tddp';

// Logo
drupalgap.settings.logo = 'themes/tddp/images/drupalgap.jpg';
...
Drupal.modules.custom['appinfo'] = {};
Drupal.modules.custom['settings'] = {};
Drupal.modules.custom['my_module_geolocation'] = {};
Drupal.modules.custom['my_module_map'] = {};
...
// tddp Theme Blocks
drupalgap.settings.blocks.tddp = {
  header: {
    user_menu_anonymous: {
      roles: {
